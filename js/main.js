...
class ProjectBlocks extends CategoryBlocks{
    constructor() {
        ...
        this.blocks = main.largeBlockProjectActive == true ? blocks[main.categoryKeyTarget].large : blocks[main.categoryKeyTarget].small;
        this.dropDownBlock = main.largeBlockCategoryActive === true ? main.categoryLargeBlock : main.categorySmallBlock;
    }
}
